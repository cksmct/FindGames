...
| 项 | 怎么算 | 数据从哪来 |
|---|---|---|
| 流量·搜索量 | `log₂(量/1000)×2` 按 30/22 归一（2 千≈2.7 · 2 万≈11.7 · 20 万≈20 · 200 万≈30）；**<1 千 = 0** | Google Trends |
...
| 动能·涨幅 | `涨幅% ÷ 1000`，上限 1（+1000% 即满分 12） | Trends 的 growth（**只有 12 种离散取值** 50/75/100…1000，本身就是分档百分比，不是连续测量） |
